...
<body>
    <?php
        ...
        $sql1 = "select CreatedOn, sum(Income) As profit from dailyanalysis group by monthname(CreatedOn) order by CreatedOn DESC ";
            echo"<br><h2 style='text-align:center;'class='font'>MONTHLY SALE DATA</h2><br>";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $d = $row["CreatedOn"];
                $da = date_parse_from_format("Y-m-d",$d);
                echo "<td>".$da['month']." / ".$da['year']."</td>";
                echo"</tr>";
            }
